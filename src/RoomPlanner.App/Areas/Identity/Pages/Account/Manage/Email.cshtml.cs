...
namespace RoomPlanner.App.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        private async Task LoadAsync(RoomPlannerIdentityUserDbo user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSenderService.SendMailConfirmationAsync(Input.NewEmail, callbackUrl);
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSenderService.SendMailConfirmationAsync(email, callbackUrl);
