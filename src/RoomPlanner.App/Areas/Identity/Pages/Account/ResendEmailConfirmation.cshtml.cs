...
namespace RoomPlanner.App.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<RoomPlannerIdentityUserDbo> userManager, CustomEmailSenderService emailSenderService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _emailSenderService.SendRegistrationMailAsync(Input.Email, callbackUrl);
