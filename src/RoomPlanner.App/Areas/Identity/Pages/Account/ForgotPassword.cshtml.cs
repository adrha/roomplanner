...
namespace RoomPlanner.App.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<RoomPlannerIdentityUserDbo> userManager, CustomEmailSenderService emailSenderService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSenderService.SendPasswordResetMailAsync(Input.Email, callbackUrl);
